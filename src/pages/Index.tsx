        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-muted p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">Sede de la asociación - Consulta ubicación</p>
            </div>
          </div>
        </div>
      </Section>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-muted p-6 rounded-lg text-center">
              ...
              <p className="text-sm text-muted-foreground">Bandas decamétricas</p>
            </div>
            <div className="bg-muted p-6 rounded-lg text-center">
              <h4 className="font-display text-lg font-bold text-foreground mb-2">VHF/UHF</h4>
              <p className="text-sm text-muted-foreground">Comunicaciones locales</p>
            </div>
            <div className="bg-muted p-6 rounded-lg text-center">
              <h4 className="font-display text-lg font-bold text-foreground mb-2">Digital</h4>
              <p className="text-sm text-muted-foreground">Modos digitales modernos</p>
            </div>
          </div>
        </div>
      </Section>
