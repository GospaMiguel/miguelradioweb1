...
• 4.000 canales y 10.000 contactos
• Potencia de salida: 5 W / 1 W
• Batería de ion-litio 2100 mAh
• Modos de trabajo: Simplex, repetidor, doble ranura`,
    },
  ],
  antenas: [],
  acopladores: [],
                      ...
                      <img
                        ...
                        className={`max-w-full h-auto rounded-lg ${
                          currentEquipment.yellowBorder
                            ? "md:max-w-[24%] border-4 border-yellow-400 shadow-[0_0_15px_rgba(250,204,21,0.6),0_0_30px_rgba(250,204,21,0.4)]"
